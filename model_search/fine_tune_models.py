        ...
        for number_of_splits in [1, 2, 4, 10]:
            for label_method in [GROUND_TRUTH, LLM]:
                ...
                train_and_evaluate_bert_like_model(
                    root_data_path, number_of_splits=number_of_splits, num_epochs=num_epochs, batch_size=batch_size,
                    model_name=model_name, results_dir=results_dir, label_method=label_method)
