...
from util.costants import RAW_OUTPUT, SENT_MESSAGES
...
def openAI_classify_review(system_prompt, review_text, model_name, wrapper_prompt=True):
...
def together_classify_review(system_prompt, review_text, model_name, wrapper_prompt=True):
    client = Together()
...
def classify_review(system_prompt, review_text, model_name, wrapper_prompt=True):
    if model_name in OPEN_AI_MODELS:
        return openAI_classify_review(system_prompt, review_text, model_name, wrapper_prompt=wrapper_prompt)
    else:
        return together_classify_review(system_prompt, review_text, model_name, wrapper_prompt=wrapper_prompt)
